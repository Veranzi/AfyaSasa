          ...
          <div className="space-y-6">
            ...
            <div className="pl-10">
              ...
              <div className="flex justify-center gap-4 mt-2">
                ...
                <a href="https://wa.me/254740875071" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="flex items-center justify-center w-12 h-12 bg-green-600/80 rounded-xl hover:bg-green-700/90 transition-all duration-300 group">
