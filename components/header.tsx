      ...
      <div className="container mx-auto px-4">
        ...
        <div className="hidden md:flex items-center justify-between py-2 text-sm border-b border-pink-50">
          ...
          <div className="flex justify-center gap-4 mt-2">
            <a href="https://github.com/afyacenter" className="flex items-center justify-center w-8 h-8 bg-gray-800/50 rounded-xl hover:bg-pink-600/30 transition-all duration-300 group">
            ...
            <a href="https://instagram.com/afyacenter" className="flex items-center justify-center w-8 h-8 bg-gray-800/50 rounded-xl hover:bg-pink-500/30 transition-all duration-300 group">
            ...
            <a href="https://x.com/afyasasa" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="flex items-center justify-center w-8 h-8 bg-gray-800/50 rounded-xl hover:bg-blue-400/30 transition-all duration-300 group">
            ...
            <a href="https://linkedin.com/company/afyasasa" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex items-center justify-center w-8 h-8 bg-gray-800/50 rounded-xl hover:bg-blue-600/30 transition-all duration-300 group">
